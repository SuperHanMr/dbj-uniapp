...
<script>
import { friendListByEstateId, deleteFriends } from "../../../api/decorate.js";
export default {
  data() {
    return {
      roomId: "",
  ...
  methods: {
    ...
    toAddFriends() {
      uni.navigateTo({
        url:
          "/sub-decorate/pages/add-friends/add-friends?roomId=" + this.roomId,
      });
    },
    addAll() {
