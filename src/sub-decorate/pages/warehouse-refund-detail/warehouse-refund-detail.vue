<template>
  <view>
    <warehouse-item :showBtns="false" :showSubtitle="false" :showBack="type==0&&ownered" :itemBtn="type==2&&ownered"
      :showPrePrice="false" :item="res" @backGoodItem="toBackGoodItem" @applyBackItem="applyBackItem">
    </warehouse-item>
    ...
    <view v-if="ownered" style="height: 136rpx;">
    ...
    <view v-if="ownered" class="bottom-btn">
      ...
      <view v-if="type==2&&res&&res.overallRefunded" class="apply-refund" @click="applyRefund">
        申请退款
      </view>
    ...
    <uni-popup ref="popup" type="bottom">
      ...
      <scroll-view :scroll-y="true" class="popup-content">
        <view v-for="(item,index) in tipsList" :key="item.id" :class="{'fontbold':index==1||index==3}"
