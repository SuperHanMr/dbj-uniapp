  ...
  export default {
    ...
    methods: {
      ...
      renewDate(pickVal) {
        ...
        // 更新小时数据
        if (!(newDayArr[newDayIndex] === currentDay && newMonthArr[newMonthIndex] === currentMonth && this.yearArr[
            newYearIndex] === currentYear)) {
          for (let i = 0; i <= 23; i++) {
            newHoursArr.push(i)
          }
        ...
        } else if (newDayArr[newDayIndex] === currentDay && newMonthArr[newMonthIndex] === currentMonth && this.yearArr[
            newYearIndex] === currentYear) {
          for (let i = currentHours; i <= 23; i++) {
            newHoursArr.push(i)
          }
        ...
        // 更新分钟数据
        // 更新小时数据
        if (!(newHoursArr[newHoursIndex] === currentHours && newDayArr[newDayIndex] === currentDay && newMonthArr[
            newMonthIndex] === currentMonth && this.yearArr[newYearIndex] === currentYear)) {
          for (let i = 0; i <= 60; i++) {
        ...
        } else if (newHoursArr[newHoursIndex] === currentHours && newDayArr[newDayIndex] === currentDay && newMonthArr[
            newMonthIndex] === currentMonth && this.yearArr[newYearIndex] === currentYear) {
