<template>
  <view class="wrap">
    ...
    >
      <image
        src="https://ali-image.dabanjia.com/static/mp/dabanjia/images/decorate/ic_go-home%402x.png"
        class=""
      >
      </image>
...
import { oauthGomeInfo, bindCapsule } from "../../api/login.js";
      ...
      if (uni.getStorageSync("scn")) {
        oauthGomeInfo({
          ...
          if (shaerId && type == "register") {
            bindCapsule({ zeusId: data.id, salesmanPhone: shaerId });
          }
          //可以改成back
