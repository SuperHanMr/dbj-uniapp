  ...
  <view style="background-color: #FFF;">
    ...
    >
      <template v-slot:back>
        <image
          class="icon_logo"
          src="http://dbj.dragonn.top/static/mp/dabanjia/images/home/dbj_logo.png"
          mode=""
        ></image>
      </template>
    </custom-navbar>
    ...
    >
      ...
      >
        ...
        <image
          v-if="citydata"
          class="icon_down"
          src="http://dbj.dragonn.top/static/mp/dabanjia/images/home/ic_home_down.png"
          mode=""
        ></image>
      </view>
      ...
      <image
        @click="toSearch"
        class="icon-search"
        src="http://dbj.dragonn.top/static/mp/dabanjia/images/home/search.png"
        mode=""
      ></image>
      <image
        @click="toMessage"
        class="img"
        src="http://dbj.dragonn.top/static/mp/dabanjia/images/home/online-server.png"
        mode=""
      >
      </image>
    </view>
    ...
    <view class="zone-view">
      <view class="function-zone function-zone-top">
        ...
        >
          ...
          <image
            v-if="(index+1)%4"
            class="border-img"
            src="http://dbj.dragonn.top/static/mp/dabanjia/images/home/home-zone-border1.png"
            mode=""
          >
          </image>
        </view>
      ...
      <!-- 金刚区 -->
      <view
        v-if="zoneList2.length"
        class="function-zone function-zone-center"
      >
        <view
          class="item"
          v-for="(item,index) in zoneList2"
          :key="item.id"
          @click="onZoneClick(item)"
        >
          <image
      ...
      <view class="function-zone function-zone-bottom">
        ...
        >
          ...
          <image
            v-if="(index+1)%4"
            class="border-img"
            src="http://dbj.dragonn.top/%20%20static/mp/dabanjia/images/home/home-zone-border1.png"
            mode=""
          >
          </image>
        </view>
    ...
    >
      ...
      >
        ...
        <image
          class="more_icon"
          src="http://dbj.dragonn.top/static/mp/dabanjia/images/home/ic_more_right.png"
          mode=""
        ></image>
      </view>
    </view>
    <view class="flex-row-common videos">
      <view
        ...
        :key="item"
        :style="{color:index==videoType?'#2B2F33':'#999999'}"
        class="video-title"
...
<script>
import { getBanner, queryLive, caseList, navList } from "../../../api/home.js";
import { getGoodsList, getClassifyList } from "../../../api/classify.js";
  ...
  methods: {
    ...
    onLiveClick(item) {
      if (item.mediaType == 1) {
        ...
        uni.navigateTo({
          url:
            "../../common/video-player/video-player?url=" +
