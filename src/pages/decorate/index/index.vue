<template>
  <view class="decorate-index">
    <image
      class="bg"
      mode="aspectFit"
      src="http://dbj.dragonn.top/static/mp/dabanjia/images/decorate/bg@2x.png"
    >
    </image>
    <view class="content">
      ...
      <view class="my-decorate-service-wrap">
        ...
        <view class="my-decorate-service">
          <view
            class="service-title flex-space-between-row"
          ...
          <service-item
            :status="DECTORE_DICT.inservice"
            itemName="量房服务"
            statusName="服务中"
          ></service-item>
          <service-item
            :status="DECTORE_DICT.robbing"
            itemName="设计服务"
            statusName="待确认设计师"
          ></service-item>
          <service-item
            :status="DECTORE_DICT.shouldsure"
            itemName="验房服务"
            statusName="验房员抢单中"
          ></service-item>
          <service-item
            :status="DECTORE_DICT.uncheck"
            itemName="精算服务"
            statusName="待确认精算师"
          ></service-item>
        </view>
      ...
      <view class="tips-design-actuary">
        ...
        <guide-card
          cardType="service"
          imageUrl="http://iph.href.lu/702x160?text=设计服务&fg=EB7662&bg=FFE2DD"
          @buyNow="buyServiceNow"
        ></guide-card>
        <guide-card
          cardType="actuary"
          imageUrl="http://iph.href.lu/702x160?text=精算服务&fg=4173c8&bg=d0e0fa"
          @buyNow="buyServiceNow"
        ></guide-card>
      </view>
      <decorate-notice
...
<script>
import { queryEstates, friendListByEstateId } from "../../../api/decorate.js";
...
import { DECTORE_DICT, SERVICE_TYPE } from "../../../utils/dict.js";
...
export default {
  ...
  methods: {
    ...
    buyServiceNow(type) {
      uni.navigateTo({
        url:
          "/sub-decorate/pages/design-service-list/design-service-list?categoryTypeId=" +
          SERVICE_TYPE[type],
      });
    },
  },
