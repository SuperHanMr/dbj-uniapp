        ...
        <swiper class="swiper" :duration="duration" @change="swiperChange" :current="currentVal">
          <swiper-item class="swiper-item">
            <scroll-view scroll-y="true" style="height: 100%" @scrolltolower="bindscrolltolower">
              <DesignCase v-if="selectStatus === 0" :leftList="leftList" :rightList="rightList" :leftHeight="leftHeight"
                :rightHeight="rightHeight" @onHeight="onHeight" @onClick="onClick" @onCollection="onCollection" />
            </scroll-view>
          </swiper-item>
          <swiper-item class="swiper-item">
            <scroll-view scroll-y="true" style="height: 100%" @scrolltolower="bindscrolltolower">
              <Decorate v-if="selectStatus === 1" :leftList="leftList" :rightList="rightList" :leftHeight="leftHeight"
                :rightHeight="rightHeight" @onHeight="onHeight" @onClick="onClick" @onCollection="onCollection" />
            </scroll-view>
          </swiper-item>
        </swiper>
