  ...
  <view>
    <web-view
      :src="baseUrl + '/app-pages/goods-detail/index.html?token=' + '#wx-goodsId='+ goodId + '&wx-houseId='
        ...
        + '&skuTemplateId=' + skuTemplateId + '&gomeDivisionCode=' + gomeDivisionCode + '&fromPackage='  + fromPackage + '&wx-bundleId='  + bundleId + '&wx-spuId=' + spuId + '&changTime=' + changTime + '&isWX=' + isWX">
    </web-view>
  </view>
</template>
