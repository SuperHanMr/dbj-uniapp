    ...
    <view v-else>
      ...
      <view class="content">
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                <image
                  class="choose-icon"
                  src="../../../static/images/ic_more_black@2x.png"
                ></image>
              </view>
            </view>
          </view>
          <view
            class="cost-detail"
            v-if="shopItem.deliveryFee && productType === 1"
          >
            <view>
              <text>运费</text>
      ...
      <view
        ...
        v-if="orderInfo.totalDeliveryFee"
      >
        <view>
          <text>商品总价</text>
...
export default {
  ...
  onShow() {
    if (
      !Number(uni.getStorageSync("houseListChooseId")) &&
      !Number(this.houseId)
    ) {
      this.isShow = false;
      setTimeout(() => {
      ...
      payOrder(params).then((data) => {
        ...
        uni.requestPayment({
          ...
          success(res) {
            ...
            uni.navigateTo({
              url:
                "/sub-classify/pages/pay-order/pay-success?orderId=" + data.id,
            });
          },
          fail(e) {
            console.log(e);
