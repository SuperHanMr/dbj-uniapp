	...
	<view class="good-toast">
		<uni-popup ref="noBuyToast" type="bottom" :mask-click="false">
			<view class="toast-content">
				...
				<address-picker originFrom="orderToast" :houseId="houseId" @closeToast="closeToast" v-if="addressShow">
				</address-picker>
				<scroll-view scroll-y="true" class="shop-scroll">
					<view class="content">
						<view class="shop-item" v-for="(shopItem, index) in noStoreInfos.storeInfos" :key='index'
							...
							<view class="goods-item" @click="toDetails(goodsItem.id)"
								v-for="(goodsItem, index) in shopItem.skuInfos" :key="index">
