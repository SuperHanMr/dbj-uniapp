<template>
  <view
    class="container"
    :style="{
      paddingBottom: dataList.length > 0 ? systemBottom : 0,
      backgroundColor: dataList.length > 0 ? '#ffffff' : '',
    }"
  >
    <view v-if="dataList.length > 0">
      ...
      >
        ...
        <view class="header">
          <view class="store-name" @click="gotoShop(item)">
            <text style="color: #333333">{{
              item.ongoingServerName ? item.ongoingServerName : item.storeName
            }}</text>
            <image
              v-if="item.type !== 5"
        ...
        <view class="body" @click="goToDetail(item)">
          <view
            class="body-main"
            v-for="(item2, index2) in item.detailAppVOS"
            :key="index2"
          >
            <view class="pic">
              <image
                :src="`${item2.imgUrl}?x-oss-process=image/resize,m_mfit,w_68,h_68`"
                mode="	scaleToFill"
              ></image>
            </view>
          ...
          <text class="product-price">
            ...
            <text class="price-font">
              ...
              <text style="font-size: 22rpx">{{
                handlePrice(item.refundAmount)[1]
              }}</text>
            </text>
          </text>
        </view>
        ...
        <view
          class="refund-status refundInProgress"
          ...
          <text>
            ...
            <text class="price-font">
              <text style="font-size: 40rpx"
                >{{ handlePrice(item.refundAmount)[0] }}.</text
              >
        ...
        <view
          class="refund-status refund-close"
