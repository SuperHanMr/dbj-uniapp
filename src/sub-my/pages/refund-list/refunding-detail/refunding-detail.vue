<template>
  <view class="container">
    ...
    >
      ...
      >
        <image
          ...
          src="https://ali-image.dabanjia.com/static/mp/dabanjia/images/theme-red/my/ic_order_refund_failed.svg"
          mode=""
        />
        <image
          v-else
          src="https://ali-image.dabanjia.com/static/mp/dabanjia/images/theme-red/my/ic_failed.svg"
          mode=""
        />
        ...
        <view
          v-if="refundInfo.status == 4 && refundInfo.type !== 6"
          class="cancel-text"
        >
      ...
      >
        ...
        <view
          class="refund-money"
          v-if="
            (refundInfo.status == 3 || refundInfo.status == 4) &&
            (refundInfo.freight || refundInfo.handlingFees)
          "
        >
          <!--运费 -->
          <view class="price-item" v-if="refundInfo.freight">
            ...
            <view class="price">
              ...
              <text class="price-style price-font"
                >{{ handlePrice(refundInfo.freight)[0] }}.{{
                  handlePrice(refundInfo.freight)[1]
                }}</text
              >
            </view>
          </view>
          ...
          <view class="price-item" v-if="refundInfo.handlingFees">
            ...
            <view>
              <text>￥</text
              ><text class="price-style price-font"
                >{{ handlePrice(refundInfo.handlingFees)[0] }}.{{
                  handlePrice(refundInfo.handlingFees)[1]
                }}</text
              >
            </view>
          </view>
      ...
      <view class="order-header1" v-if="refundInfo.status == 2">
        ...
        <view
          class="router"
          v-if="refundInfo.deductedAmount"
          :style="{
            marginBottom:
              refundInfo.weChatRefundedAmount || refundInfo.cardRefundedAmount
                ? '16rpx'
                : '0',
          }"
        >
        ...
        <view
          class="router"
          v-if="refundInfo.cardRefundedAmount"
          :style="{
            marginBottom: refundInfo.weChatRefundedAmount ? '16rpx' : '0',
          }"
        >
          <text style="color: #999999; font-size: 26rpx"
            >原路径退回至储值卡</text
          >
          <view>
            <text style="font-size: 20rpx">￥</text>
        ...
        <view
          class="router"
          v-if="refundInfo.weChatRefundedAmount"
          :style="{
            marginBottom: refundInfo.couponRefundedAmount ? '16rpx' : '0',
          }"
        >
          <text style="color: #999999; font-size: 26rpx"
            >原路径退回至原账户</text
        ...
        <view
          class="router"
          v-if="refundInfo.couponRefundedAmount"
      ...
      <view
        ...
        :style="{
          paddingBottom:
            refundInfo.type == 2 ||
            (productLength == 1 && refundInfo.type !== 5)
              ? '32rpx'
              : '0',
        }"
      >
        ...
        />
        <store-calue-card-item v-else :dataInfo="item1" />
      </view>

      <!-- 退款中 -->
      <view
        class="refund-product-info"
        v-if="refundInfo.status == 0 || refundInfo.status == 1"
        :style="{
          paddingBottom:
            refundInfo.type == 2 ||
            (productLength == 1 && refundInfo.type !== 5)
      ...
      <view class="offline-info" v-if="refundInfo.isOrderCompanyTransfer">
        <view class="header"> 退款线下收款信息 </view>
        <view class="item">
    ...
    <view
      v-if="
        refundInfo.contactCustomer ||
        refundInfo.reapplyed ||
        refundInfo.cancelRefunded
      "
      class="footerBtn-container"
      :style="{ paddingBottom: systemBottom }"
    >
      <view
        v-if="refundInfo.contactCustomer"
      ...
      <view
        v-if="refundInfo.cancelRefunded"
        class="button"
        @click="cancelToPay()"
      >
        取消退款
...
export default {
      ...
      refundStatusList: [
        {
          value: 0,
          imgUrl:
            "https://ali-image.dabanjia.com/static/mp/dabanjia/images/theme-red/my/ic_status_inprogress.svg",
          statusName: "退款中",
        },
        {
          value: 1,
        ...
        },
        {
          value: 2,
          imgUrl:
            "https://ali-image.dabanjia.com/static/mp/dabanjia/images/theme-red/my/ic_order_success.svg",
          statusName: "退款成功",
        },
        {
          value: 3,
          imgUrl:
            "https://ali-image.dabanjia.com/static/mp/dabanjia/images/theme-red/my/ic_order_failed.svg",
          statusName: "退款关闭",
        },
        {
          value: 4,
  ...
  methods: {
    ...
    cancelToPay() {
      console.log(
        "this.refundInfo.approvalCompleted==",
        this.refundInfo.approvalCompleted
      );
