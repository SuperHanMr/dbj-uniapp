  ...
  >
    ...
    <view class="order-container">
      ...
      >
        ...
        <view
          v-if="orderInfo.showApplyAfterSalesBtn"
          class="applyforRefund"
          @click="toApplyForAfterSales()"
        >
          申请售后
        </view>
      </view>
      ...
      orderStatusList: [
        {
          value: 0,
          imgUrl:
            "https://ali-image.dabanjia.com/static/mp/dabanjia/images/theme-red/my/ic_status_wait_pay.svg",
          statusName: "待付款",
        },
        {
          value: 1,
