<template>
	<view class="container">
		...
		<view class="order-container" :style="{paddingBottom:112+containerBottom+'rpx'}">
			...
			<order-user-base-info v-if="orderInfo.customerName && orderInfo.customerPhone && orderInfo.estateInfo"
				:data="orderInfo" />
			...
			<view v-if="haveCard && orderInfo.type == 5" class="pay-way" style="justify-content:center"
				@click="clickCard">
