    ...
    <view v-if='houseId'>
      <view class="header-address">
        ...
        <view class="address" @click="checkAddress">
          ...
          <view class="community">{{(addressInfo.area + addressInfo.housingEstate + addressInfo.address)?(addressInfo.area + addressInfo.housingEstate + addressInfo.address):''}}</view>
          <view class="userInfo">
