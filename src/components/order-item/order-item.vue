<template>
  <view class="container">
      ...
      <view class="basic-info">
        ...
        <view class="common-price">
          ...
          <view
            style="color: #999999;"
            v-if="refundType"
          >共{{dataList.refundNumber}}件</view>
          <view
            style="color: #999999;"
            v-else
          >共{{dataList.number}}件</view>
        </view>
      </view>
    </view>
    ...
    <view
      ...
      v-if="dataList.type == 1 && orderStatus==2 && dataList.stockType && dataList.stockType == 2"
    >
      <view class="left">
    ...
    <view
      ...
      v-if="dataList.showRefundBtn && (orderStatus==2 || orderStatus == 3)"
    >
      <view
        class="button"
        @click="particalRefund"
      >
        申请退款
      </view>
    </view>
...
export default {
  ...
  mounted() {
    ...
    if (
      (this.dataList.stockTyp &&
        this.dataList.stockType == 2 &&
