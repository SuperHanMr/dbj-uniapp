<template>
  <view class="nav">
    ...
    <view
      class="bg_box"
      :style="{
        backgroundColor: navConfig.bgColor,
        backgroundImage: navConfig.bgImage,
    ...
    >
      ...
      >
        <view
          ...
          :style="{
            ...
            borderRadius: navConfig.type2Config.radius,
          }"
          v-if="navConfig.btnType == 'type2' && !isHome"
        >
          <view
        ...
        >
          ...
          <view
            ...
            :style="{
              height: inputHeight,
              backgroundColor: navConfig.searchConfig.bgColor,
              marginRight: navConfig.searchConfig.marginRight,
          ...
          >
            ...
            <input
              ...
              :placeholder="navConfig.searchConfig.placeholder"
              :disabled="navConfig.searchConfig.disabled"
              @tap="clickInput"
              @input="changeInput"
              @confirm="submitInput"
              @confirm-type="navConfig.searchConfig.ctype || 'search'"
      ...
      >
        <text
          ...
          :style="{
            color: navConfig.navTitle.color,
...
/* 默认首页图标路径 */
const homeIconPath = "/static/home_b.svg";
/* 默认返回图标路径 */
const backIconPath = "/static/back_b.svg";
export default {
  props: {
    navConfig: {
      type: Object,
  ...
  watch: {
    scrollTop(val) {
      if (!this.navConfig.isOpacity) {
        return;
      }
      this.setOpacity(val, this.navConfig.opacityTime);
    },
  },
  methods: {
    init() {
      if (this.navConfig.isHome) {
