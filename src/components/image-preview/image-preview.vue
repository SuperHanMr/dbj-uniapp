<template>
  <view class="img-list" :style="{maxHeight:hasHeight?maxHeight:'auto',marginBottom:-lineSpace+'rpx',marginRight:-colSpace+'rpx',overflow: isHidden}">
    <image class="img-item" :style="{width:imgWidth+'rpx',height:imgHeight+'rpx',marginBottom:lineSpace+'rpx',marginRight:colSpace+'rpx'}" v-for="(el,index) of list" @click="previewImage(list,index)" :key='el' :src="el"></image>
