<template>
  <view class="store">
    ...
    <view
      v-for="(goodItem,index) in dataList"
      :key="index"
      :class="{'bor-bottom':index<dataList.length-1}"
      class="goods-list"
    >
      <view
        class="good-detail"
      ...
      >
        ...
        <view class="goods-info">
          <view class="name">
            ...
            <view
              v-if="showSubPrice&&item.stockStatus!=4"
              class="price"
            >
      ...
      >
        <custom-number-box
          @change="onChange($event,goodItem)"
          :value="goodItem.number"
          :min="minInput"
          :max="goodItem.number"
        >
        </custom-number-box>
      ...
      >
        <view
          v-if="goodItem.status==6"
          class="apply-back"
          @click="applyBackItem(goodItem)"
        >
          申请退款
        </view>
        <view
          v-if="[0,1].includes(goodItem.status)"
          style="color:#FC8B19"
          class="apply-back"
        >
          退款中
        ...
        <view
          v-if="[2].includes(goodItem.status)"
          class="apply-back"
        >
          退款成功
        </view>
        <view
          v-if="[3,4].includes(goodItem.status)"
          class="apply-back"
        >
          退款关闭
        </view>
        <view
          v-if="goodItem.status==5"
          style="color:#FF3347"
          class="apply-back"
        >
          申请失败
