<template>
  <view class="text-scroll">
    <view
      ...
      @click="goDecorateCalendar"
    >
      <image
        class="icon-rili"
        src="http://dbj.dragonn.top/static/mp/dabanjia/images/decorate/ic_rl.svg"
      ></image>
      ...
      <image
        class="icon-r"
        src="http://dbj.dragonn.top/static/mp/dabanjia/images/decorate/ic_more.svg"
      ></image>
    </view>
  </view>
</template>
