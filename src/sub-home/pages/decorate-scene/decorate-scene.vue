  ...
  >
    ...
    >
      ...
      >
        <image
          class="noDynamicsImg"
          src="https://ali-image.dabanjia.com/static/mp/dabanjia/images/home/pic_empty%402x.png"
        ></image>
    ...
    <view class="footer">
      ...
      >
        <image src="https://ali-image.dabanjia.com/static/mp/dabanjia/images/home/question.png"></image>
        <view>咨询客服</view>
      </view>
      <view
        class="userWant"
        @click="toDecorate"
      >
        <image src="https://ali-image.dabanjia.com/static/mp/dabanjia/images/home/decorate.png"></image>
        <view>我要装修</view>
      </view>
      <view
        class="focusOn"
    ...
    <view
      class="mask"
      v-if="showDecorateMask"
    >
      <view
        class="popupDecorate"
        :class="{'height':hasEstate}"
      >
        <view
          class="estateInfo"
          v-if="!hasEstate"
    ...
    expandC(id, index) {
      ...
      getReplies(params).then((data) => {
        if (data) {
          ...
          if (this.replyPage !== 1) {
            this.comments[index].secondComments = this.comments[
              index
            ].secondComments.concat(list || []);
          } else {
        ...
        if (data) {
          ...
          nodes.map((item, index) => {
            ...
            if (arr.find((item) => item.nodeStatus !== 1)) {
              ...
              this.newestNodeIndex = this.nodeTypes.findIndex(
            ...
            this.workers.push({
              id: item.serveId,
              name:
                item.serveName.length <= 3
                  ? item.serveName.slice(0, 3)
                  : item.serveName.slice(0, 2),
