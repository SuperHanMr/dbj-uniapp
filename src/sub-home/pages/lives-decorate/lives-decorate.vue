<template>
  <view class="fill">
    <live-player
      ...
      :class="{ player:!isFill,'player-fill':isFill}"
      :src="livePreview"
      autoplay
...
<script>
import { workVideo, bindVideoList } from "../../../api/home.js";
export default {
  data() {
    return {
      muted: false,
